...
class Mesh_mae(nn.Module):
    ...
    def forward(self, faces, feats, centers, Fs, cordinates):
        ...
        #######################################################################
        # pred_vertices_coordinates = pred_vertices_coordinates.reshape(batch, -1, 3)
        # pcd = o3d.geometry.PointCloud()
        # pcd.points = o3d.utility.Vector3dVector((pred_vertices_coordinates[0]).cpu().detach().numpy())
        # o3d.io.write_point_cloud('/data/lcs/test.ply', pcd)
        # exit()
        return loss
