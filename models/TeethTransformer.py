...
class TeethTransformer(nn.Module):
    def __init__(self, patch_size=2, in_chans=1024, embed_dim=512, depth=12, num_heads=8, mlp_ratio=4.,
        ...
        self.label_emb = nn.Sequential(
            nn.Linear(32*in_chans, 8*embed_dim),
            nn.GELU(),
