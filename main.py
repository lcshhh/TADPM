...
from models import *
from runners.train_tadpm import train_tadpm
from runners.test_tadpm import test_tadpm
def get_args():
...
def main():
    ...
    # run
    if args.test:
        test_tadpm(args, config, logger)
    else:
        train_tadpm(args, config, train_writer, val_writer, logger)
