...
from models import *
from runners.train_single import train_single
from runners.test_single import test_single
def get_args():
...
def main():
    ...
    # run
    if args.test:
        test_single(args, config, logger)
    else:
        train_single(args, config, train_writer, val_writer, logger)
